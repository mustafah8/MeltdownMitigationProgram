...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    :param theoretical_max_power: int or float - power that corresponds to 100% efficiency.
...
def fail_safe(temperature, neutrons_produced_per_second, threshold ):
    """Assess and return status code for the reactor.
        ...
        """
    decay_rate = temperature * neutrons_produced_per_second
    ratio = decay_rate/ threshold
    if ratio < 0.9:
        return 'LOW'
    elif ratio <1.1:
        return 'NORMAL'
